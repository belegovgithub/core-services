 ...
 * matchIfMissing = true)
 * 
 * @Slf4j public class DefaultServiceImpl implements SMSService {
 * 
 ...
 * 
 * private void submitToExternalSmsService(Sms sms) { try { String url =
 * smsProperties.getUrl(); HttpEntity<HttpEntity<MultiValueMap<String, String>>>
 * request = new HttpEntity<>(getRequest(sms), getHttpHeaders()); String
